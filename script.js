...
const POKEDEX_NAME_ALIASES = {
  ...
  "AegislashB": "Aegislash",
  "I. Valiant": "Iron Valiant",
  "Rotom Fr.": "Frostrotom",
  "Rotom F.": "Fanrotom",
  "Rotom H.": "Heatrotom",
  "Rotom W.": "Washrotom",
...
const buildAllowedPokedexList = () =>
  ALLOWED_POKEDEX_NAMES.map((displayName) => {
    const alias = POKEDEX_NAME_ALIASES[displayName];
    ...
    const id = POKEMON_IDS[canonicalName];
...
const initPokedexPage = async () => {
  pokemonList = buildAllowedPokedexList();
